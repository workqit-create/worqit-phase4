        ...
        <div style={{
          ...
          {loading ? (
            <div style={{ padding: 20 }}>
              {[1, 2, 3].map(i => (
                <div key={i} style={{ height: 64, background: C.line, borderRadius: 10, marginBottom: 8, opacity: .5 }} />
              ))}
            </div>
            ...
            <div style={{ padding: "48px 20px", textAlign: "center", color: C.silver }}>
              ...
              <div style={{ fontSize: 12, opacity: .7 }}>Apply to jobs or connect with candidates to start chatting</div>
            </div>
          ) : (
                ...
                >
                  <div style={{
                    ...
                    {conv.myUnread > 0 && (
                      ...
                      }}>{conv.myUnread > 9 ? "9+" : conv.myUnread}</div>
                    )}
                  </div>
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    <div style={{
                      color: conv.myUnread > 0 ? C.text : C.silver,
